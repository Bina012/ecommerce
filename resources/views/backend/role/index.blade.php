...
@section('main-content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <a href="{{route('backend.role.create')}}" class="btn btn-info">Create {{$panel}}</a>
                            ...
                            <table class="table-bordered table" id="ecommerce1">
                                ...
                                @foreach($data['records'] as $record)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route($base_route . 'assign_form',$record->id)}}" class="btn btn-success">Assign  Permission</a>
