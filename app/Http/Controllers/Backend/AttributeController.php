...
class AttributeController extends BackendBaseController
{
    ...
    protected  $file_path = 'images' . DIRECTORY_SEPARATOR . 'backend' . DIRECTORY_SEPARATOR . 'attribute' . DIRECTORY_SEPARATOR;
    ...
    {
        $data['records'] = Attribute::orderby('created_at','desc')->get();
    ...
    public function update(AttributeRequest $request, $id)
    {
        ...
        if ($data['record']->update($request->all())){
            $request->session()->flash('success','Attribute update success');
        }else{
